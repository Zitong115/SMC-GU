        ...
        do
            ...
            do
                ...
                choose_gpu_with_least_load() {
                    ...
                    for ((gpu_id = 3; gpu_id < $gpu_count; gpu_id++)); do
                ...
                echo "Start ${info}"
                output_file="./output/ours_adaptiveselection_test_0603_products.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 2 \
                    --file_name ./output/ours_adaptiveselection_0603_products \
                    --scale 50000 \
                    --iteration 10 \
                    --batch_size 512 \
                    --test_ratio 0.1 \
