    ...
    do
        ...
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/test_sampling_on_citeseercora_20250512.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 3 \
                    --file_name ./output/test_sampling_on_citeseercora_20250512 \
                    --evaluation True \
                    --scale 100000 \
                    --iteration 10 \
                    --batch_size 512\
                    --test_ratio 0.1 \
                    --gif_sampling_dataset $c \
                    --gif_stochastic False \
                    --use_remained_info_for_update 0 >> $output_file 2>&1 &
                pid=$!
