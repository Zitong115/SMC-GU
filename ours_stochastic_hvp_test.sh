    ...
    do
        ...
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/ours_stochastic_hvp_test_20250318_no_noise_batch_1_damp_08.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 3 \
                    --file_name ./output/ours_stochastic_hvp_test_20250318_no_noise_batch_1_damp_08 \
                    --scale 50000 \
                    --iteration 10 \
                    --batch_size 512 \
                    --test_ratio 0.1 \
                    --hessian_approximation_method stochastichvp \
                    --hvp_sampling_K 1 \
                    --gaussian_std 0 \
                    --hvp_sampling_size 1000 >> $output_file 2>&1 &
