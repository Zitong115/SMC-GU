...
for a in Physics ogbn-arxiv ogbn-products reddit
do
    ...
    do
        ...
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/ablation_stochastic_D0_20250225.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 1 \
                    --file_name ./output/ablation_stochastic_D0_20250225 \
                    --scale 50000 \
                    --iteration 10 \
                    --batch_size 512\
                    --test_ratio 0.1 \
                    --gif_stochastic True \
                    --hvp_sampling_K 10 \
                    --gif_sampling_dataset 500 \
                    --gaussian_std 0 >> $output_file 2>&1 &
