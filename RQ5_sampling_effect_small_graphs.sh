...
for a in cora citeseer CS
do

    for b in node
    do

        for c in SGC GCNNet GIN GAT 
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/RQ5_20250617_sampling_effect_small_graphs.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 3 \
                    --file_name ./output/RQ5_20250617_sampling_effect_small_graphs \
