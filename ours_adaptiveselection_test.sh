...
for a in reddit #Physics ogbn-arxiv  ogbn-products
do
        ...
        do
            ...
            do
                ...
                choose_gpu_with_least_load() {
                    ...
                    for ((gpu_id = 2; gpu_id < $gpu_count; gpu_id++)); do
                ...
                echo "Start ${info}"
                output_file="./output/ours_adaptiveselection_test_0603_reddit.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 2 \
                    --file_name ./output/ours_adaptiveselection_0603_reddit \
                    --scale 50000 \
                    --iteration 10 \
                    --batch_size 512 \
                    --test_ratio 0.1 \
                    --hessian_approximation_method adaptiveselection \
                    --importance_measurement pagerank \
                    --hvp_sampling_K 5 \
                    --gaussian_std 0 \
                    --hvp_sampling_size -1 >> $output_file 2>&1 &
