    ...
    do
        ...
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/retrain_SimpleGCN_products_0524.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 1 \
                    --file_name ./output/retrain_SimpleGCN_products_0524 \
                    --scale 50000 \
                    --iteration 10 \
                    --batch_size 512 \
                    --test_ratio 0.1 \
                    --save_remained_data False \
                    --load_remained_data_for_retraining True \
