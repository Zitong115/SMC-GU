...
for a in ogbn-papers100M # Physics ogbn-arxiv 
do

    for b in 0.9997 0.9998 0.9999
    do
        ...
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./memory_test_ogbn-paper100M_20250511.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 1 \
                    --evaluation False \
                    --file_name memory_test_ogbn-paper100M \
                    --scale 100000 \
