...
for a in CS # cora citeseer 
do

    for b in edge
    do

        for c in GIN # GCNNetGAT 
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/test_retrain_small_graphs_20250425.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 1 \
                    --file_name ./output/test_retrain_small_graphs_20250425 \
                    --scale 100000 \
                    --iteration 10 \
                    --batch_size 512\
                    --test_ratio 0.1 \
                    --gif_sampling_dataset 1 >> $output_file 2>&1 &
