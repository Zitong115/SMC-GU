...
for a in Physics ogbn-arxiv reddit ogbn-products
do
    ...
    do
        ...
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/ours_pagerank_test_0321.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --num_runs 3 \
                    --file_name ./output/ours_pagerank_test_0321 \
                    --scale 50000 \
                    --iteration 10 \
                    --batch_size 512 \
                    --test_ratio 0.1 \
                    --hessian_approximation_method importancesampling \
                    --importance_measurement pagerank \
                    --hvp_sampling_K 1 \
                    --gaussian_std 0 \
                    --hvp_sampling_size 10000 >> $output_file 2>&1 &
