    ...
    do
        ...
        do
            ...
            do
                ...
                echo "Start ${info}"
                output_file="./output/small_graph_with_higher_neighbor_20250616_GCN.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --use_remained_info_for_update 1 \
                    --unlearn_method IDEA \
                    --unlearn_task $b \
                    --unlearn_ratio $d \
                    ...
                    --num_runs 3 \
                    --file_name ./output/small_graph_with_higher_neighbor_20250616_GCN \
