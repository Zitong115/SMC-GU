...
do
    ...
    do
        ...
        do
            ...
            for d in 0.01 0.02 0.03 0.1 0.2 0.3
            do
                ...
                info="Dataset = ${a} task unlearn = ${b} model = ${c} sampling ratio = ${d}"

                echo "Start ${info}"
                output_file="./output/RQ5_20250617_sampling_effect_Physics.txt"
                ...
                nohup python main.py --dataset_name $a \
                    ...
                    --use_remained_info_for_update 0 \
                    --unlearn_method IDEA \
                    --unlearn_task $b \
                    --unlearn_ratio 100 \
                    ...
                    --num_runs 2 \
                    --file_name ./output/RQ5_20250617_sampling_effect_Physics \
                    --hessian_approximation_method hvpgif \
                    --scale 100000 \
                    --gaussian_std 0 \
                    --iteration 10 \
                    --batch_size 512\
                    ...
                    --gif_stochastic True \
                    --hvp_sampling_K 1 \
                    --gif_sampling_dataset $d >> $output_file 2>&1 &
